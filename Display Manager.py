...
class QRCreator:
    ...
    def __init__(self, odometerRead, fuelEconomy, fuelLevel1,engineHours,fuelUsed,DataPlate):
        ...
        self.odometerRead = self.odometerRead * 10
        self.fuelEconomy = self.fuelEconomy * 10
        self.fuelLevel1 = self.fuelLevel1 * 10
        self.engineHours = self.engineHours * 10
        self.fuelUsed = self.fuelUsed * 10

        self.odometerRead = int(round(self.odometerRead))
        self.fuelEconomy = int(round(self.fuelEconomy))
        self.fuelLevel1 = int(round(self.fuelLevel1))
        self.engineHours = int(round(self.engineHours))
        self.fuelUsed = int(round(self.fuelUsed))
